...
public class ChangePersonTest {
    ...
    @Test(testName = "ChangePersonTest")
                ...
                threadGroup("POST_IMPORT_PERSON_THREAD_GROUP", 4, 10)
                        .children(
                                ...
                                ifController(s -> !entities.isEmpty(),
                                        jsr223Action(s -> {
                                            JsonObject jsonObject = new Gson().fromJson(entities.poll(), JsonObject.class);
                                            s.vars.put("id", jsonObject.get("id").getAsString());
                                            s.vars.put("json", jsonObject.toString());
                                        }),
                                        httpSampler("UPDATE_PERSON", "api/person/${id}/change")
                                                .method("PUT")
